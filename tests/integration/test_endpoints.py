...
class TestIngestEndToEnd:
    def test_aggregates(self, real_data, client):
    ...
    def test_link_detail_returns_result(self, real_data, client, db):
    ...
    def test_spatial_filter_returns_results(self, real_data, client):
        resp = client.post(
    ...
    def test_slow_links_returns_results(self, real_data, client):
        resp = client.get(
            "/patterns/slow_links/",
